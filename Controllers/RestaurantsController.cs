...
namespace WebApplication1.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Category,Rating,Price")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Category,Rating,Price")] Restaurant restaurant)
        {
            if (id != restaurant.ID)
            {
                return NotFound();
